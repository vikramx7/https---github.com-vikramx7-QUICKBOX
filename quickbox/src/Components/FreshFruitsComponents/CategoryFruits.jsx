...
<div className={Style.tomorrow}><FontAwesomeIcon className={Style.truck} icon={faTruck}></FontAwesomeIcon><p className={Style.Delivery}>Standard Delivery:</p></div>
<p className={Style.time}>Within 30 mins</p>
